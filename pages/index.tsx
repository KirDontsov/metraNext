...
const DynamicMap = dynamic(() => import("../components/NextMap"), { ssr: false });
const DynamicQuiz = dynamic(() => import("../components/Quiz"), { ssr: false });

const title = "Такси Метра - Всепогодная служба легкового пассажирского такси и транспорта под заказ";
const description =
